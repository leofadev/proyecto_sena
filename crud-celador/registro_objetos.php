...
if (!empty($_POST["btnIngresar"])) {
    if (!empty($_POST["nombre"]) AND !empty($_POST["document"]) AND !empty($_POST["apellido"]) AND !empty($_POST["cargo"]) AND !empty($_POST["dispositivo"]) AND !empty($_POST["observacion"])) {
        $documento=$_POST["document"];
        $nombre=$_POST["nombre"];
        $cargo=$_POST["apellido"];
        $cargo=$_POST["cargo"];
