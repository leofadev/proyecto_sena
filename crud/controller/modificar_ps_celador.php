...
<?php
if (!empty($_POST["btnModificar_c"])) {
    if (!empty($_POST["tipo_documento"]) AND!empty($_POST["correo"]) AND!empty($_POST["nombre"]) AND!empty($_POST["apellido"])) {
        $id=$_POST["id"];
        ...
        if ($sql==1) {
            header("Location:./homepage_celador.php");
        } else {
